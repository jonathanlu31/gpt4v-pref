...
class GPT:
    ...
    @staticmethod
    def query_images(path1: str, path2: str, query="What are in these images? Is there any difference between them?"):
    ...
    @staticmethod
    def query_videos(path1: str, path2: str, query="What are in these videos? Is there any difference between them?"):
